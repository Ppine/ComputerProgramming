...
public class SMM{
    ...
    static void addStaff() {
        ...
        System.out.print("Sex (M(0)/F(1)): ");
        boolea sex = scanner.next().charAt(0);
        System.out.print("Year of Joining: ");
        int year = scanner.nextInt();
        System.out.print("Salary: ");
        int salary = scanner.nextInt();

        staffList.add(new Staff(name, birthYear, sex, year, salary));
    ...
    static void addStudent() {
        ...
        studentList.add(new Student(name, birthYear, sex, year, grade));
    ...
    static void listStaff() {
        ...
        for (Staff s : staffList) s.displayInfo();
    }
